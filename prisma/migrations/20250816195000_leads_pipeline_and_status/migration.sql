-- AlterTable
-- Add new columns for Lead model (only if they don't exist)
...
-- Copy howHeard to source
UPDATE "Contact" SET "source" = "howHeard" WHERE "source" IS NULL AND "howHeard" IS NOT NULL;
